...
@Service
public class ConsultarContratoImpl  implements ConsultarContrato{

	private static transient Logger logger = Logger.getLogger(ConsultarContratoImpl.class);
	...
	public ConsultarContratosResponse consultarContrato(String msjTx, ConsultarContratosRequest request, HeaderRequest header,
		...
		ConsultarContratosResponse response = new ConsultarContratosResponse();
		long tiempoInicio = System.currentTimeMillis();

		String errorMsg = Constantes.Vacio;
		String url = prop.consultarContratoUri;
		String nombreComponente = prop.consultarContratoNombre;
		String nombreMetodo = prop.consultarContratoMetodo;
		...
		try {
			...
			clientConfig.getProperties().put(ClientConfig.PROPERTY_CONNECT_TIMEOUT, Integer.parseInt(prop.consultarContratoConnectTimeOut));
			clientConfig.getProperties().put(ClientConfig.PROPERTY_READ_TIMEOUT, Integer.parseInt(prop.consultarContratoReadTimeOut));
			...
			response = builder.method(HttpMethod.POST, ConsultarContratosResponse.class, request);
